...
//   Error,
//   isIdentifier,
// } from "./parser/types.mjs";
// import { transpose } from "./parser/utils.js";
...
//   assert(
//     errors.length === 0,
//     source + " was parsed with errors:\n\t" + errors.join("\n\t")
//   );
//   assert(
//     res.length === 1,
//     source +
//       " has more operators than expected: " +
//       JSON.stringify(res, null, 2)
//   );
//   const [operator] = res;
//   assert(
//     typeof operator !== "string",
//     source + " has string operators: " + JSON.stringify(res, null, 2)
//   );
//   assert(
//     operator.type === "operator",
//     source + " does not contain operator: " + JSON.stringify(res, null, 2)
//   );
//   assert(
//     operator.item === op,
//     source + ' does not contain "if" operator: ' + JSON.stringify(res, null, 2)
//   );
// };
...
//       _operands.length === 2,
//       source +
//         " does not contain exactly 2 operands: " +
//         JSON.stringify(res, null, 2)
//     );
//     assert(
//       _operands[0].length === 0 && _operands[1].length === 1,
//       source +
//         " does not contain exactly 0, 1 repeated operand: " +
//         JSON.stringify(res, null, 2)
//     );
//     assert(
//       isIdentifier(op1),
//       source + " operands are not identifiers: " + JSON.stringify(res, null, 2)
//     );
//     assert(
//       op1.item === "x",
//       source + " operands are not identifiers: " + JSON.stringify(res, null, 2)
