...
@lh_names_effect_handlers = dso_local global [3 x ptr] [
  ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 0), 
  ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 1),
  ptr null
]
@action_a = constant %struct.lh_optag_ { ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 2), i64 0 }, align 8
@action_b = constant %struct.lh_optag_ { ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 2), i64 1 }, align 8
...
@handlers = internal constant %struct._lh_handlerdef { 
  ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 2), 
  ptr null, 
  ptr null, 
  ptr @return_handler, 
  ptr @handler_actions 
...
entry:
  ...
  store ptr getelementptr inbounds({ i8* }, ptr @symbols_metadata_array, i32 2), ptr %action_a_effect
