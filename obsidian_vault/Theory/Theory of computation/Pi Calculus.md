...
channels can encode some relation between input and output. Since we can express any logical relation with y=f(x), it can be implied by the communication on that channel, encoded by the protocol.
